...
export default function Modal({children, className }:IModal):JSX.Element{
    return (
        <> 
            <label htmlFor={className} className="cursor-pointer bg-[#ABDEE6] rounded-lg	w-4/5 text-center uppercase tracking-wider font-extrabold p-3 mr-6">Prosseguir</label>
